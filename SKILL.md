...
- For Workshop stacks, treat the Workshop source directory as the highest-priority source path and map the id directly to `<workshop-root>/<workshop-id>`.
- Default Workshop roots:
  - Windows: `C:\Program Files (x86)\Steam\steamapps\workshop\content\322330\<workshop-id>`
  - Linux: `~/.local/share/Steam/steamapps/workshop/content/322330/<workshop-id>`
  - macOS: `~/Library/Application Support/Steam/steamapps/workshop/content/322330/<workshop-id>`
- Do not first probe `common/Don't Starve Together/mods/workshop-<workshop-id>` when the traceback already contains `workshop-<workshop-id>`.
