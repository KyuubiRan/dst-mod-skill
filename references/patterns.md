...
Use this page as the grouped router for detail docs under `references/patterns/`.

## Entry, Bootstrap, And File Placement

- `references/patterns/entrypoint-patterns.md`
- `references/patterns/modinfo-patterns.md`
- `references/patterns/modmain-patterns.md`
- `references/patterns/execution-contexts.md`

## Prefabs, Components, Tags, And Gameplay Systems
...
## Runtime, Networking, Persistence, And Shards

- `references/patterns/runtime-globals.md`
...
## UI, Assets, Animation, Strings, And Presentation
...
- start here when you know the broad subsystem but not the exact page
- jump to `references/signatures.md` when parameter order is the real question
- jump to `references/pitfalls.md` when the code already exists but behaves wrong
