...
If the task is mainly about the structure or item prefab itself, also read `references/feature-recipes.md` and `references/creation-patterns.md`.
...
- `references/texture-patterns.md`
