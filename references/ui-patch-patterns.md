...
If the task also needs raw input, read `references/input-patterns.md`.
If the task should change real gameplay state, read `references/networking-patterns.md` or `references/action-patterns.md`.
