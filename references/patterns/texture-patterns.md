...
If the task also touches prefab asset registration, read `references/patterns/asset-patterns.md`.
...
- If the task is about asset declaration, read `references/patterns/asset-patterns.md`.
