...
If the task is really about world generation or host setup, read `references/patterns/worldgen-patterns.md` instead.
If the task is ordinary client/server replication on one shard, read `references/patterns/networking-patterns.md` instead.
