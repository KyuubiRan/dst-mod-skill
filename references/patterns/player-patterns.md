...
If the task is mainly about one playable character prefab, read `references/patterns/character-patterns.md`.
If the task touches local HUD or screens, also read `references/patterns/runtime-local-ui.md`.
If the task touches player action states or prediction, also read `references/patterns/stategraph-patterns.md`.
If the task needs player-owned replicated state or `player_classified`, also read `references/patterns/player-network-patterns.md`.
...
- "touch only the local active player's HUD or screen"
  - `playeractivated` plus `references/patterns/runtime-local-ui.md`
