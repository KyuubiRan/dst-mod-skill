...
If you only need exact function signatures, read `references/signatures/hook-signatures.md`.
If the task is specifically about players as a class, also read `references/patterns/player-patterns.md`.
...
If the task is really about owner-only player sync, also read `references/patterns/player-network-patterns.md`.
...
- if the hard part is choosing the class rather than the hook, read `references/patterns/ui-patch-patterns.md`
