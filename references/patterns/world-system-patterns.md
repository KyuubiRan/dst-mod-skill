...
If the task is mainly about choosing `Make*` helper constructors from `scripts/standardcomponents.lua`, also read `references/patterns/standard-helper-patterns.md`.
