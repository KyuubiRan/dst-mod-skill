...
Read `references/patterns/entrypoint-patterns.md` first when the task is still deciding between `modmain.lua`, `modworldgenmain.lua`, and `modservercreationmain.lua`.
