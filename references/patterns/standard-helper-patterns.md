...
Read `references/signatures/helper-signatures.md` for exact parameter order.
Read `references/patterns/world-system-patterns.md` when the task is mainly about component behavior rather than helper selection.
