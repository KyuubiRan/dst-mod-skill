...
If the task is mainly about entry-file choice first, read `references/patterns/entrypoint-patterns.md`.
If the task is mainly about runtime i18n layout, also read `references/patterns/runtime-i18n-patterns.md`.
If the task is mainly about recipes unlocked by character progression, also read `references/patterns/recipe-patterns.md`.
If the task is mainly about general atlases, icons, or anim zips beyond character-specific frontend assets, also read `references/patterns/asset-patterns.md`.
If the task is mainly about real wardrobe-selectable character skins rather than portraits or preview modes, also read `references/patterns/skin-patterns.md`.
...
- "I need full official-style character skins for a mod character."
  - switch to `references/patterns/skin-patterns.md` and treat it as an advanced UI-plus-data task
- "I need unlockable perks or skill-gated recipes."
  - add the optional skill tree
- "I need custom player actions or SG changes."
  - read `references/patterns/action-patterns.md` and `references/patterns/stategraph-patterns.md`
