...
If the task is only "apply this to every player", read `references/player-patterns.md` first.
If the task is generic RPC, netvar, or replica design, also read `references/networking-patterns.md`.
