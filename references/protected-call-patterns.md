...
If the task is mainly about persistent local files, also read `references/persistent-string-patterns.md`.
If the task is mainly about entity or world save lifecycle, also read `references/persistence-patterns.md`.
