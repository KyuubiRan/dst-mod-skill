...
- if the task needs implementation shape, read `references/templates/networking-templates.md`
- if the task is specifically about player-owned or owner-only player state, read `references/patterns/player-network-patterns.md`
- if the bug is mostly authority confusion, read `references/patterns/runtime-authority.md`
- if the bug is mostly symptom-driven, read `references/patterns/diagnostic-patterns.md`
