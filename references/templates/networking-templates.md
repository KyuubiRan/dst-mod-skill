...
This page complements `references/patterns/networking-patterns.md`.
Read that file first for the decision framework, then use this file for implementation shapes.
If the target is player-owned owner-only state, also read `references/patterns/player-network-patterns.md`.
